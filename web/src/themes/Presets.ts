...
import { WollFishBasicTheme as WollFishBasicDarkTheme } from './templates/dark/Wollfish';
...
import { WollFishBasicTheme as WollFishBasicLightTheme } from './templates/light/Wollfish';
...
export const AVAILABLE_THEME_PRESETS: ThemePresetInterface[] = [
    ...
    {
        theme_id: 6,
        title: 'page.body.customization.themes.theme.wollfish.title',
        theme_colors: {
            light: WollFishBasicLightTheme,
            dark: WollFishBasicDarkTheme,
        },
    },
];
